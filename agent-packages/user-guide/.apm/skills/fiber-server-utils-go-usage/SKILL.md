---
  ...
  description: Builder for fiber.App preconfigured with Qubership cloud-core middleware (context-propagation, security, request-id-aware logging, health, prometheus, pprof, tracing). Use when writing or reviewing Go microservices that expose
  REST over fiber.
  ---
